            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {loading ? (
                        ...
                        jobs.map(job => (
                            <div key={job.id} className="bg-surface rounded-xl shadow-sm border border-outline-variant/20 p-6 flex flex-col hover:shadow-md transition-shadow">
                                ...
                                <div className="text-xs text-on-surface-variant bg-surface-container-low p-3 rounded-lg">
                                    ...
                                    <p className="line-clamp-2">
                                        {job.skills?.map(s => s.skill_name).join(', ') || 'None'}
                                    </p>
                                </div>
                            </div>
                        ))
